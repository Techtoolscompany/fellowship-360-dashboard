            ...
            >
                <div className="card-body p-4 d-flex flex-column">
                        ...
                        {data.needsAttention > 0 && (
                            <span
                                style={{
                                    ...
                                    borderRadius: '360px', background: '#bbff00', color: '#343330',
                                }}
                            >
                    ...
                    <div className="d-flex gap-4 mb-3">
                        <div>
                            <p className="mb-0" style={{ fontSize: '24px', fontWeight: 700, color: '#bbff00' }}>{data.inPipeline}</p>
                            <span style={{ fontSize: '11px', color: '#9ca3af' }}>In Pipeline</span>
                        </div>
                        <div>
                            <p className="mb-0" style={{ fontSize: '24px', fontWeight: 700, color: '#fff' }}>{data.newThisWeek}</p>
                    ...
                    <div className="d-flex gap-2 mb-3">
                        {data.stages.map((stage, i) => (
                            <div key={i} className="text-center" style={{ flex: 1 }}>
                                ...
                                />
                                <span style={{ fontSize: '10px', color: '#9ca3af' }}>{stage.count}</span>
                            </div>
                        ))}
                    </div>
                    ...
                    <Link 
                        ...
                        style={{ fontSize: '13px', fontWeight: 600, color: '#bbff00', textDecoration: 'none' }}
                    >
