        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Basic settings to control Grace AI availability and core identity.
              </CardDescription>
            </CardHeader>
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
                      ...
                      <FormDescription>
                        When disabled, Grace AI will not respond to queries or appear in the app.
                      </FormDescription>
                    </div>
                    <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Helps localize Grace context.</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Influences theological tone.</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Provide custom instructions to override Grace default personality.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Leave blank to use the default optimized prompt. If provided, this fully
                      replaces the base instruction.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Role and scheduling matrices now have dedicated settings pages.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-sm text-muted-foreground">
                Manage role requirements in Role Matrix settings and volunteer/staff availability in
                Scheduling Matrix settings.
              </p>
